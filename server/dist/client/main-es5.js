(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function W4x(module, __webpack_exports__, __webpack_require__) {
      ...
      function RegisterComponent_li_9_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function RegisterComponent_li_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "li");
      ...
      var RegisterComponent = /*#__PURE__*/function () {
        function RegisterComponent(fb, router, alertService, authService) {
        ...
        _createClass(RegisterComponent, [{
          ...
          value: function register() {
            ...
            this.authService.register(username, password).then(function (data) {
              console.log(data);
              _this.registerError = false;

              _this.router.navigateByUrl('');

              _this.alertService.sendAlert('Registration successful! You may now login.');
            })["catch"](function (err) {
              console.error(err);
      ...
      RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 20,
        vars: 5,
        consts: [[3, "formGroup", "ngSubmit"], [1, "my-3"], [1, "form-floating", "mb-1"], ["type", "text", "id", "username", "placeholder", "Username", "formControlName", "username", 1, "form-control"], ["for", "username"], [1, "mt-2", "small"], [1, "text-danger"], [4, "ngIf"], [1, "form-floating", "mb-3"], ["type", "password", "id", "password", "placeholder", "Password", "formControlName", "password", 1, "form-control"], ["for", "password"], ["type", "submit", 1, "btn", "btn-primary", "btn-lg", "w-100", 3, "disabled"], ["class", "mt-3 text-danger", 4, "ngIf"], [1, "mt-3", "text-danger"]],
    ...
    function hj4(module, __webpack_exports__, __webpack_require__) {
      ...
      var AlertComponent = /*#__PURE__*/function () {
        function AlertComponent(alertService, router) {
        ...
        _createClass(AlertComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.alertSubscription = this.alertService.getAlert().subscribe(function (message) {
              console.log("In alertComponent | subscribed message = ".concat(message));
            ...
            this.routeSubscription = this.router.events.subscribe(function (event) {
              if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_0__["NavigationStart"]) {
                _this2.alertService.clearAlert();
              }
            });
          }
        }, {
      ...
      AlertComponent.ɵfac = function AlertComponent_Factory(t) {
        return new (t || AlertComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_alert_service__WEBPACK_IMPORTED_MODULE_2__["AlertService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_0__["Router"]));
      };
      ...
      AlertComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 3,
        vars: 1,
        consts: [["id", "alert", "role", "alert", 1, "alert", "alert-success", "alert-dismissible", "fade", "show", "mt-2"], ["type", "button", "aria-label", "Close", 1, "btn-close", 3, "click"]],
        template: function AlertComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AlertComponent_Template_button_click_2_listener() {
              return ctx.hideAlert();
            });
    ...
    function DLXL(module, __webpack_exports__, __webpack_require__) {
      ...
      var ArticleComponent = /*#__PURE__*/function () {
        ...
        _createClass(ArticleComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.http.get("".concat(_constants__WEBPACK_IMPORTED_MODULE_0__["SERVER_URL"], "/api/articles/").concat(id)).toPromise().then(function (data) {
              console.log(data);
              _this3.article = data;
              _this3.article.imageDataUrl = 'data:' + _this3.article.imageMimeType + ';base64,' + _this3.article.imageBuffer;
            })["catch"](function (err) {
      ...
      ArticleComponent.ɵfac = function ArticleComponent_Factory(t) {
        return new (t || ArticleComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]));
      };
      ...
      ArticleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 13,
        vars: 8,
        consts: [[1, "mt-3"], [1, "w-100", 3, "src"], [1, "my-3"], [1, "small"], [1, "bi", "bi-calendar", "me-1"], [1, "bi", "bi-person", "me-1"]],
    ...
    function PIX(module, __webpack_exports__, __webpack_require__) {
      ...
      var AuthGuard = /*#__PURE__*/function () {
        function AuthGuard(authService, alertService, router) {
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 23,
        vars: 2,
        consts: [[1, "container-fluid"], [1, "d-flex", "pt-3", "pb-2", "justify-content-between"], ["routerLink", "/", 1, "text-decoration-none", "text-body", "fw-bold"], [1, "bi", "bi-newspaper"], ["routerLink", "/articles/view"], ["routerLink", "/articles/post"], ["routerLink", "/login", 4, "ngIf"], ["data-bs-toggle", "modal", "href", "#logoutModal", 4, "ngIf"], ["id", "logoutModal", "tabindex", "-1", 1, "modal", "fade"], [1, "modal-dialog"], [1, "modal-content"], [1, "modal-header"], [1, "modal-title"], ["type", "button", "data-bs-dismiss", "modal", "aria-label", "Close", 1, "btn-close"], [1, "modal-body", "d-flex", "justify-content-end"], ["type", "button", "data-bs-dismiss", "modal", 1, "btn", "btn-danger", 3, "click"], ["routerLink", "/login"], ["data-bs-toggle", "modal", "href", "#logoutModal"]],
        ...
        directives: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterLinkWithHref"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"], _alert_alert_component__WEBPACK_IMPORTED_MODULE_4__["AlertComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterOutlet"]],
    ...
    function YdJ5(module, __webpack_exports__, __webpack_require__) {
      ...
      var AlertService = /*#__PURE__*/function () {
        ...
        _createClass(AlertService, [{
          key: "sendAlert",
          value: function sendAlert(message) {
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _article_list_article_list_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      var _post_article_post_article_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./post-article/post-article.component */
      "c5Cx");
      /* harmony import */


      var _http_interceptors_auth_interceptor__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      var _webcam_webcam_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./webcam/webcam.component */
      "j60U");
      /* harmony import */


      var _article_article_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      ...
      var ROUTES = [{
        ...
        path: 'articles/view',
        component: _article_list_article_list_component__WEBPACK_IMPORTED_MODULE_8__["ArticleListComponent"]
      }, {
        path: 'articles/view/:id',
        component: _article_article_component__WEBPACK_IMPORTED_MODULE_15__["ArticleComponent"]
      }, {
        path: 'articles/post',
        component: _post_article_post_article_component__WEBPACK_IMPORTED_MODULE_10__["PostArticleComponent"],
        canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]]
      }, {
        path: 'articles/capture',
        component: _webcam_webcam_component__WEBPACK_IMPORTED_MODULE_14__["WebcamComponent"],
        canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]]
      }, {
        path: '**',
      ...
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_17__["ɵɵdefineInjector"]({
        ...
        providers: [{
          ...
          useClass: _http_interceptors_auth_interceptor__WEBPACK_IMPORTED_MODULE_11__["AuthInterceptor"],
          multi: true
        }],
        imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClientModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forRoot(ROUTES), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], ngx_webcam__WEBPACK_IMPORTED_MODULE_13__["WebcamModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_17__["ɵɵsetNgModuleScope"](AppModule, {
          declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_6__["HomeComponent"], _page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_7__["PageNotFoundComponent"], _article_list_article_list_component__WEBPACK_IMPORTED_MODULE_8__["ArticleListComponent"], _alert_alert_component__WEBPACK_IMPORTED_MODULE_9__["AlertComponent"], _post_article_post_article_component__WEBPACK_IMPORTED_MODULE_10__["PostArticleComponent"], _webcam_webcam_component__WEBPACK_IMPORTED_MODULE_14__["WebcamComponent"], _article_article_component__WEBPACK_IMPORTED_MODULE_15__["ArticleComponent"], _register_register_component__WEBPACK_IMPORTED_MODULE_16__["RegisterComponent"]],
    ...
    /***/
    function c5Cx(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var PostArticleComponent = /*#__PURE__*/function () {
        function PostArticleComponent(http, fb, router, alertService) {
        ...
        _createClass(PostArticleComponent, [{
          ...
          value: function post() {
            ...
            var imageFile = this.imageDataUrlToFile(this.imageSrc);
            var formData = new FormData();
            formData.append('title', title);
            formData.append('comments', comments);
            formData.append('imageFile', imageFile);
            this.http.post("".concat(_constants__WEBPACK_IMPORTED_MODULE_1__["SERVER_URL"], "/api/articles"), formData).toPromise().then(function (data) {
              console.log(data);

              _this4.clear();

              _this4.alertService.sendAlert('Article posted successfully!');
            })["catch"](function (err) {
              console.error(err);

              _this4.alertService.sendAlert('Error encountered when posting article.');
            });
          }
        }, {
          key: "clear",
          ...
          key: "isImageCaptured",
          value: function isImageCaptured() {
            return this.imageSrc !== this.imagePlaceholderSrc;
          }
        }, {
          key: "imageDataUrlToFile",
          value: function imageDataUrlToFile(dataUrl) {
            var split = dataUrl.split(',');
            var mime = split[0].match(/:(.*?);/)[1];
            var bstr = atob(split[1]);
            var n = bstr.length;
            ...
            var file = new File([u8arr], 'placeholder', {
              type: mime
            });
            return file;
          }
      ...
      PostArticleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        type: PostArticleComponent,
        selectors: [["app-post-article"]],
        decls: 22,
        vars: 4,
        consts: [[3, "formGroup", "ngSubmit"], [1, "my-3"], [1, "text-center", "mb-3"], [3, "src", "ngClass"], ["for", "title", 1, "h5", "mb-2"], ["type", "text", "id", "title", "placeholder", "Title", "formControlName", "title", 1, "form-control", "mb-3"], ["for", "comments", 1, "h5", "mb-2"], ["id", "comments", "placeholder", "Your thoughts", "formControlName", "comments", "rows", "5", 1, "form-control", "mb-3"], [1, "d-flex", "justify-content-between"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [1, "bi", "bi-share-fill"], ["type", "button", 1, "btn", "btn-warning", 3, "click"], [1, "bi", "bi-trash-fill"], ["type", "button", 1, "btn", "btn-danger", 3, "click"], [1, "bi", "bi-camera-fill"]],
        template: function PostArticleComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "form", 0);

            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngSubmit", function PostArticleComponent_Template_form_ngSubmit_0_listener() {
              return ctx.post();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function PostArticleComponent_Template_button_click_16_listener() {
              return ctx.clear();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function PostArticleComponent_Template_button_click_19_listener() {
              return ctx.capture();
            });
    ...
    function ccyI(module, __webpack_exports__, __webpack_require__) {
      ...
      var AuthService = /*#__PURE__*/function () {
        function AuthService(router, alertService, http) {
        ...
        _createClass(AuthService, [{
          ...
          value: function login(username, password) {
            ...
            var success = false;
            this.http.post("".concat(_constants__WEBPACK_IMPORTED_MODULE_0__["SERVER_URL"], "/api/users/login"), body).toPromise().then(function (data) {
              localStorage.clear();
              var date = new Date();
              ...
              _this5.router.navigateByUrl(_this5.redirectUrl);

              _this5.alertService.sendAlert('Login successful!');
          ...
          value: function register(username, password) {
            ...
            return this.http.post("".concat(_constants__WEBPACK_IMPORTED_MODULE_0__["SERVER_URL"], "/api/users/register"), body).toPromise();
          }
        }]);
      ...
      AuthService.ɵfac = function AuthService_Factory(t) {
        return new (t || AuthService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_alert_service__WEBPACK_IMPORTED_MODULE_3__["AlertService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]));
      };
    ...
    /***/
    function eofC(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ArticleListComponent = /*#__PURE__*/function () {
        ...
        _createClass(ArticleListComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.http.get("".concat(_constants__WEBPACK_IMPORTED_MODULE_0__["SERVER_URL"], "/api/articles")).toPromise().then(function (data) {
              data.forEach(function (article) {
                article.imageDataUrl = 'data:' + article.imageMimeType + ';base64,' + article.imageBuffer;
              });
              _this6.articles = data;
            })["catch"](function (err) {
              console.error(err);
            });
          }
      ...
      ArticleListComponent.ɵfac = function ArticleListComponent_Factory(t) {
        return new (t || ArticleListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
      };
      ...
      ArticleListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 2,
        vars: 1,
        consts: [[1, "row", "row-cols-1", "mt-3", "d-flex", "justify-content-center"], ["class", "col text-center", 4, "ngFor", "ngForOf"], [1, "col", "text-center"], [3, "routerLink"], [1, "w-100", 3, "src"], [1, "mt-2"], [1, "small"], [1, "bi", "bi-calendar", "me-1"]],
    ...
    /***/
    function j60U(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "WebcamComponent", function () {
        return WebcamComponent;
      });
      /* harmony import */


      var ngx_webcam__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ngx-webcam */
      "QKVY");
      /* harmony import */
      ...
      var WebcamComponent = /*#__PURE__*/function () {
        function WebcamComponent(router) {
        ...
        _createClass(WebcamComponent, [{
          ...
          value: function ngOnInit() {
            ...
            ngx_webcam__WEBPACK_IMPORTED_MODULE_0__["WebcamUtil"].getAvailableVideoInputs().then(function (mediaDevices) {
              _this7.multipleWebcamsAvailable = mediaDevices && mediaDevices.length > 1;
            });
          }
        }, {
          key: "back",
      ...
      WebcamComponent.ɵfac = function WebcamComponent_Factory(t) {
        return new (t || WebcamComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
      };

      WebcamComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        type: WebcamComponent,
        selectors: [["app-webcam"]],
        decls: 14,
        vars: 5,
        consts: [[1, "my-3"], [1, "text-center", "border", "border-secondary", "pt-1"], [3, "width", "trigger", "allowCameraSwitch", "switchCamera", "imageCapture"], [1, "d-flex", "justify-content-between", "mt-3"], ["type", "button", 1, "btn", "btn-dark", 3, "click"], [1, "bi", "bi-arrow-left-circle-fill"], ["type", "button", 1, "btn", "btn-danger", 3, "click"], [1, "bi", "bi-camera-fill"], ["type", "button", 1, "btn", "btn-info", 3, "disabled", "click"], [1, "bi", "bi-arrow-repeat"]],
        template: function WebcamComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("imageCapture", function WebcamComponent_Template_webcam_imageCapture_3_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function WebcamComponent_Template_button_click_5_listener() {
              return ctx.back();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function WebcamComponent_Template_button_click_8_listener() {
              return ctx.capture();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function WebcamComponent_Template_button_click_11_listener() {
              return ctx["switch"]();
            });
        ...
        directives: [ngx_webcam__WEBPACK_IMPORTED_MODULE_0__["WebcamComponent"]],
    ...
    function rQPh(module, __webpack_exports__, __webpack_require__) {
      ...
      PageNotFoundComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 2,
        vars: 0,
        consts: [[1, "d-flex", "justify-content-center", "mt-3"], ["src", "../../assets/404.jpg", 1, "w-100"]],
    ...
    function vtpD(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginComponent = /*#__PURE__*/function () {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function login() {
            var username = this.form.get('username').value;
            var password = this.form.get('password').value;
            var success = this.authService.login(username, password);
      ...
      LoginComponent.ɵfac = function LoginComponent_Factory(t) {
        return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]));
      };
      ...
      LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 21,
        vars: 3,
        consts: [[3, "formGroup", "ngSubmit"], [1, "my-3"], [1, "form-floating", "mb-1"], ["type", "text", "id", "username", "placeholder", "Username", "formControlName", "username", 1, "form-control"], ["for", "username"], [1, "form-floating", "mb-3"], ["type", "password", "id", "password", "placeholder", "Password", "formControlName", "password", 1, "form-control"], ["for", "password"], ["class", "text-danger", 4, "ngIf"], ["type", "submit", 1, "btn", "btn-success", "btn-lg", "w-100", 3, "disabled"], [1, "bi", "bi-door-open-fill"], [1, "mt-3"], ["routerLink", "/register"], [1, "text-danger"]],
        ...
        directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["ɵangular_packages_forms_forms_y"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["NgControlStatusGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormGroupDirective"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormControlName"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterLinkWithHref"]],
